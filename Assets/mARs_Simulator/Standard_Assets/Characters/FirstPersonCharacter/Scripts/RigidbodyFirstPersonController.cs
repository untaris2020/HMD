...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : MonoBehaviour
    {
        ...
        public GameObject freeLookHead;
        ...
        private void Start()
        {
            ht = GameObject.Find("SceneManager").GetComponent<HeadTracking>();
            m_RigidBody = GetComponent<Rigidbody>();
            m_Capsule = GetComponent<CapsuleCollider>();
            mouseLook.Init (transform, cam.transform);
            curRot = transform.localEulerAngles;

            var startPos =  worldCenter.transform.position;
            startPos.y += 1;
        ...
        private void Update()
        {
            ...
            if (Input.GetKeyDown(KeyCode.Alpha1) || Input.GetKeyDown(KeyCode.Keypad1)) {
                // Index
                currentFingerInput.SetValues(0, 1, 0, 0, 0);
                ht.forceClick(currentFingerInput); 
            } 
            else if (Input.GetKeyDown(KeyCode.Alpha2) || Input.GetKeyDown(KeyCode.Keypad2)) {
                // Index
                currentFingerInput.SetValues(0, 0, 1, 0, 0);
                ht.forceClick(currentFingerInput); 
            } 
            else if (Input.GetKeyDown(KeyCode.Alpha3) || Input.GetKeyDown(KeyCode.Keypad3)) {
                // Index
                currentFingerInput.SetValues(0, 0, 0, 1, 0);
                ht.forceClick(currentFingerInput); 
            } 
            else if (Input.GetKeyDown(KeyCode.Alpha4) || Input.GetKeyDown(KeyCode.Keypad4)) {
                // Index
                currentFingerInput.SetValues(0, 0, 0, 0, 1);
                ht.forceClick(currentFingerInput); 
            }
        ...
        private void RotateView()
        {
            ...
            if (Input.GetKey(KeyCode.LeftAlt))
            {
                ...
                //        camXAngle = CrossPlatformInputManager.GetAxis("Mouse X") * XSensitivity;
                //        m_CameraTargetRot *= Quaternion.Euler (-xRot, 0f, 0f);
                //        // Rotate the HEAD freely by camXAngle.
                //        freeLookHead.transform.Rotate(Vector3.up * m_CameraTargetRot);
                //    }

                mouseLook.FreeLookRotation(freeLookHead.transform, cam.transform);
            }
            // If the player is not pressing the freelook button.
            else
            {
                mouseLook.LookRotation(transform, freeLookHead.transform,  cam.transform);
                // Set Slerp initial rotation.
                //intitialRot = freeLookHead.transform.rotation;
                //// Slerp rotation of the head back to the body's rotation.
                //freeLookHead.transform.rotation = Quaternion.Slerp(intitialRot, transform.rotation, snapTime);
                ...
                //    transform.Rotate(Vector3.up * camXAngle);
                //}
            }
            ...
            //    camYAngle = CrossPlatformInputManager.GetAxis("Mouse Y") * YSensitivity;
            ...
            //if (Input.GetKey(KeyCode.LeftAlt)) {
            //    Debug.Log("alt");
            //    //mouseLook.FreeLookRotation (cam.transform);
            //    mouseLook.LookRotation(freeLookHead.transform, cam.transform);
            //} else {
            //    freeLookHead.transform.localRotation = Quaternion.Slerp (freeLookHead.transform.localRotation, new Quaternion(0,0,0,0),
            //        5f * Time.deltaTime);
            ...
            //    Debug.Log("alt down");
            //    // Save head position
            //    storedCamTransform = cam.transform.rotation;
            //}
